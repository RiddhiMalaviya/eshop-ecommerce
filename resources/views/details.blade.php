                                ...
                                <div class="cloth-details-size">
                                    ...
                                    @csrf
                                        ...
                                        <div class="product-buttons">
                                            <a href="javascript:void(0)" onclick="addProductToWishlist('{{$product->id}}','{{$product->name}}',1,'{{$product->regular_price}}')" class="btn btn-solid hover-solid btn-animation">
                            ...
                            <div class="tab-pane fade show active" id="desc">
                                <div class="shipping-chart">
                                    ...
                                    <div class="row g-3 align-items-center">
                                        ...
                                        <div class="col-lg-4">
                                            <img src="{{asset('assets/images/fashion/slider/1.jpg')}}"
                                        ...
                                        <div class="col-lg-4 order-lg-0 mt-4">
                                            <img src="{{asset('assets/images/fashion/slider/2.jpg')}}"
                                                class="img-fluid rounded blur-up lazyload" alt="">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="customer-rating">
                                            ...
                                            <div class="global-rating">
                                                <h5 class="font-light">  Ratings</h5>
                                            </div>
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="review-box">
                                            <form action="{{route('reviews.store')}}" method="post" >
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <label class="mb-1" for="id">rating</label>
                                        ...
                                        <div class="customer-review-box">
                                            ...
                                            <div class="customer-section">
                                                ...
                                                <div class="customer-details">
                                                    ...
                                                    <p class="font-light">I purchased the Tablet May 2021 and now April
                                                        2024
