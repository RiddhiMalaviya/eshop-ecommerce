...
@section('content')
                                            ...
                                            @foreach ($brands as $brand)
                                                <li>
                                                    <div class="form-check ps-0 custome-form-check">
                                                        <input class="checkbox_animated check-it" id="br{{$brand->id}}" name="brands" @if(in_array($brand->id,explode(',',$q_brands))) checked="checked" @endif value="{{$brand->id}}" type="checkbox" onclick="filterProductsByBrand(this)">
                                            ...
                                            <li>
                                                <div class="form-check ps-0 custome-form-check">
                                                    <input class="checkbox_animated check-it" type="checkbox"
                                                        id="discount5" value="5">
                                                    <label class="form-check-label" for="discount5">5% and
                                                        above</label>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="form-check ps-0 custome-form-check">
                                                    ...
                                                    <label class="form-check-label" for="discount10">10% and
                                                        above</label>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="form-check ps-0 custome-form-check">
                                                    ...
                                                    <label class="form-check-label" for="discount20">20% and
                                                        above</label>
                                                </div>
                                            </li>
                                        </ul>
    ...
    <form id="frmFilter" method="GET">
        ...
        <input type="hidden" name="thankyou" id="thankyou" value="" />
    ...
    <script> 
        ...
        function filterProductByDiscount()
        {
            ...
            $("input[name='discounts']:checked").each(function(){
                discounts.puch($(this).val());
            });
            $("#discounts").val(discounts.json(","));
            $("#frmFilter").submit();
        }
    </script>
@endpush