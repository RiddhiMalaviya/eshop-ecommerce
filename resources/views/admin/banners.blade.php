        ...
        <div class="row">
            <div class="card-body">
                <div class="card-header py-3">
                    <a href="{{route('banner.create')}}" class="btn btn-primary btn-sm float-left" data-toggle="tooltip"
                    data-placement="bottom" title="Add banner"><i class="fas fa-plus"></i> Add Banner</a>
                        ...
                        <table class="table cart-table">
                            ...
                            @foreach($banners as $banner)
                                <tr>
                                    ...
                                    <td scope="row">{{$banner->slug}}</td>
                                    <td scope="row">{{$banner->description}}</td>
                                    <td scope="row">{{$banner->image}}</td>
                                    <td>
