                                ...
                                <div class="main-navbar">
                                    <div id="mainnav">
                                        ...
                                        <ul class="nav-menu">
                                            ...
                                            <li><a href="{{route('aboutus.index')}}" class="nav-link menu-title">About Us</a></li>
                                            <li><a href="{{route('contactus.index')}}" class="nav-link menu-title">Contact Us</a></li>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-contact">
                            ...
                            <ul class="contact-lists" style="clear:both;">
                                <li>
                                    <span><b>phone:</b> <span class="font-light"> +1 123546789</span></span>
                                </li>
                                <li>
                                    <span><b>Address:</b><span class="font-light"> Ahmedabad , Gujarat
                                            India</span></span>
                                </li>
                                <li>
                                    <span><b>Email:</b><span class="font-light"> contact@eshop.in</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="footer-links">
                            ...
                            <div class="footer-content">
                                <ul>
                                    ...
                                    <li>
                                        <a href="{{route('contactus.index')}}" class="font-dark">Contact</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                        <div class="footer-links">
                            ...
                            <div class="footer-content">
                                <ul>
                                    <li>
                                        <a href="{{route('cart.index')}}" class="font-dark">Your Orders</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('users.index') }}" class="font-dark">Your Account</a>
                                    </li>
                                    <li>
                                        <a href="{{route('wishlist.list')}}" class="font-dark">Your Wishlist</a>
                                    </li>
                                    <!-- <li>
                            ...
                            <form id="subscribe-form" method="POST" action="{{route('subscribe')}}">
                                ...
                                <div class="form-newsletter">
                                    <div class="input-group mb-4">
                                        <input type="email" id="email" name="email" class="form-control color-4" placeholder="Your Email Address" required>
                                        <button class="btn btn-solid-default" type="submit"><i class="fas fa-arrow-right"></i></button>
                                    </div>
        ...
        <div class="sub-footer">
            <div class="container">
                <div class="row gy-3">
                    ...
                    <div class="col-md-6">
                        <p class="mb-0 font-dark">© 2024, Eshop.</p>
                    </div>
                </div>
            </div>
        </div>
