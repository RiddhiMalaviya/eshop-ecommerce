        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-xl-5 offset-xl-1">
                    <div class="row g-3">
                        <div class="col-md-6">
                            <img src="{{asset('assets/images/inner-page/review-image/6.jpg')}}"
                                class="img-fluid rounded-3 about-image" alt="">
                        </div>
                        <div class="col-md-6">
                            <img src="{{asset('assets/images/inner-page/review-image/7.jpg')}}"
                                class="img-fluid rounded-3 about-image" alt="">
                        </div>
                        <div class="col-12 ratio_40">
                            <div>
                                <img src="{{asset('assets/images/inner-page/review-image/8.jpg')}}"
